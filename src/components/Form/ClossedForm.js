...
import { CardContent, Grid, SvgIcon, Box, Typography } from '@material-ui/core'

export const ClossedForm = (props) => {
  const { email } = props
  return (
    <>
      <CardContent>
      ...
      <CardContent>
        <Grid container>
          ...
          <Box ml={3}>
            <Typography variant="body1">Укажите номер телефона</Typography>
          </Box>
        </Grid>
      </CardContent>
    </>
